...
const Contact = () => {
  ...
  return (
    <div className="pt-10 w-full leading-8 text-secondary">
      ...
      <p className="max-w-2k mt-8 mb-16 m-auto px-8 text-justify">Hello there! Thank you for visiting my social networks. I&apos;m currently actively seeking new job opportunities and would love to connect with you to discuss code and potential collaborations on interesting projects. Whether you have an opportunity available or just want to chat about technology, feel free to reach out! I&apos;m open to new ideas and excited about what the future may hold. Looking forward to hearing from you soon!</p>
      <div className={divStyles}>
        <a className={aStyles + " border-t-0"} href="/">
          <FaLinkedin />
